...
$LibraryTests = "error property property_list support xml_attribute xml_tag"
...
Function RunTest
{
	...
	$TestExecutable = "${TestExecutablesDirectory}\fplist_test_${TestName}.exe"
...
Function RunTestWithInput
{
	...
	$TestProfileDirectory = GetTestProfileDirectory "input" "libfplist"
